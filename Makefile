...
ACLOCAL = ${SHELL} '/home/jhkim/curl-8.2.1/missing' aclocal-1.16
AMTAR = $${TAR-tar}
...
AR_FLAGS = cr
AS = as
AUTOCONF = ${SHELL} '/home/jhkim/curl-8.2.1/missing' autoconf
AUTOHEADER = ${SHELL} '/home/jhkim/curl-8.2.1/missing' autoheader
AUTOMAKE = ${SHELL} '/home/jhkim/curl-8.2.1/missing' automake-1.16
AWK = gawk
BLANK_AT_MAKETIME = 
CADDY = 
CC = gcc
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} '/home/jhkim/curl-8.2.1/missing' makeinfo
MANIFEST_TOOL = :
MANOPT = -man
...
SSL_LIBS = 
STRIP = strip
SUPPORT_FEATURES = AsynchDNS IPv6 Largefile UnixSockets alt-svc libz threadsafe
SUPPORT_PROTOCOLS = DICT FILE FTP GOPHER HTTP IMAP MQTT POP3 RTSP SMTP TELNET TFTP
...
abs_builddir = /home/jhkim/curl-8.2.1
abs_srcdir = /home/jhkim/curl-8.2.1
abs_top_builddir = /home/jhkim/curl-8.2.1
abs_top_srcdir = /home/jhkim/curl-8.2.1
ac_ct_AR = 
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/jhkim/curl-8.2.1/install-sh
